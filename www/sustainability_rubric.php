...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  if ( empty( $errors ) ) 
  {
    ...
    { echo '<div class = "container">
			...
			<p>You have successfully updated your sustainability details!</p>
			<a class = "alert-link" href = "user_profile.php">Take a look.</a>
			</div>
			</div>'; }
...
<html lang="en">
  <head>
	...
	<!-- Styling for the drop-down menu choices to help users make their choice. -->
	<style>
	...
	<!-- Opens container. -->
		<div class = "input-group">
			<div class = "col-sm">
			<p><center>Subscribe to the sustainability rubric system by rating how the company performed! Choose between three different rankings: poor, intermediate, and great.</center></p>
				<!-- A simplified layout separating the labels and the drop-down forms collecting information for ease of viewability. -->
